...
<div class="status mtsuperadmin topich row">
 <div class="col-lg-6">
  <h1>Marketplace - Likes</h1>
  <h3>Title : {{$AdsObj->title}}</h3>
  </div>
     <div class="col-lg-6">
  <a href="{{url("opslogin/marketplace")}}" class='submitchat  float-right'>Back to Summary</a>
  </div>
</div>
                   ...
                   <div class="overflowscroll2">
                     ...
                     <tbody>
                       @if($lists)
                        ...
                        @php 
                        $userinfo = $BlkUserObj->likeduserinfo($user->user_id,$user->account_id);
                        @endphp
                        <tr>
                        ...
                        <td class="spacer">{{($user->created_at != '0000-00-00' && $user->created_at != '')?date('d/m/y',strtotime($user->created_at)):''}}</td>
                           <td class="roundright">
							   ...
							   <div class="dropdown">
                                       ...
                                       <a class="dropdown-item" href="#" onclick="delete_record('{{url("opslogin/marketplace/likes/delete/$user->id")}}');">Delete</a>
