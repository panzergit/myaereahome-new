...
@php
$reportobj = new \App\Models\v2\MpAdsSubmission();
...
<div class="status mtsuperadmin topich row">
 <div class="col-lg-6">
  ...
  <h3>Title : {{$AdsObj->title}}</h3>
  </div>
     <div class="col-lg-6">
     <a href="{{url("opslogin/marketplace/allreports")}}" class='submitchat  float-right'>Back to Reports</a>
  </div>
</div>
  ...
  <div class="row">
               <div class="col-lg-12">
                  <ul class="summarytab">
                     ...
                     <li><a href="{{url('/opslogin/marketplace/blockedusers')}}" >Blocked Users</a> </li>
                  </ul>
               </div>
               </div>
                        ...
                        <tr>
                           ...
                           <td class="roundright">
							   ...
							   <div class="dropdown">
                                       ...
                                       @if($user->status ==1)
                                             <a class="dropdown-item" href="{{url("opslogin/marketplace/hidereport/$user->id")}}">Hide</a>
                                          @else
                                             <a class="dropdown-item" href="{{url("opslogin/marketplace/showreport/$user->id")}}">Show</a>
                                          @endif
                                          <a class="dropdown-item" href="{{url("opslogin/marketplace/warninguser/$user->id")}}">Warning User</a>
                                          <a class="dropdown-item" href="{{url("opslogin/marketplace/blockuser/$user->id")}}">Block User</a>
