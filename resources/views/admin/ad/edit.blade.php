...
<div class="row">
      ...
      @endif
       ...
       <div class="">
                {!! Form::model($adObj,['method' =>'PATCH','class'=>'forunit','files' => true,'url' => url('opslogin/configuration/ads/'.$adObj->id)]) !!}
                ...
                <div class="row asignbg editbg">
                    ...
                    <div class="col-lg-4">
                      <div class="form-group ">
                          <label>title : </label>
                          {{ Form::text('ad_title', null, ['class'=>'form-control','required' => true]) }}
                     ...
                     <div class="col-lg-4">
                      <div class="form-group">
                          <label>banner (100px X 150px):</label>
                           <div class="">
                           @if(!empty($adObj->ad_image))
                                 <label for="file-input">
                                    <img src="{{$file_path}}/{{$adObj->ad_image}}" class="viewimg"/>
                                 </label>
                           @endif
                                 {{ Form::file('ad_image', null, ['class'=>'form-control','required' => false]) }}
                              </div>
