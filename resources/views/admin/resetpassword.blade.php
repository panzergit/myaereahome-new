                  ...
                  <div class="form-group row">
                          ...
                          <div class="col-sm-8 plogin">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-8 plogin">
                                 <input id="password" type="password" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="@if(Session::has('tmp_user')){{ Session::get('tmp_user') }}@else{{ old('email') }}@endif" required autofocus>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-8 plogin">
                                 <input id="c-password" type="c-password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required>
