  ...
  <div class="img-show">
    ...
    <img src="">
	   ...
	   <div class="col-lg-12 asignFace">
                 ...
                 {!! Form::model($eformObj,['method' =>'PATCH','class'=>"forunit", 'autocomplete'=>"off", 'files' => true,'url' => url('opslogin/eform/renovation/inspectionsave/'.$eformObj->id)]) !!}
                           ...
                           <div class="form-group ">
                              ...
                              <div id="sandbox4">
                                 {{ Form::text('date_of_completion', (isset($eformObj->inspection->date_of_completion) && $eformObj->inspection->date_of_completion !='0000-00-00')?$eformObj->inspection->date_of_completion:'', ['id'=>'datetext2', 'class'=>'form-control','placeholder' => '']) }}
                                 </div>
                           </div>
                           </div>
						   <div class="col-lg-4">
                        ...
                        <div class="col-lg-4">
                           ...
                           <div class="form-group ">
                              ...
                              <div id="sandbox">
                                 {{ Form::text('resident_signature_date', (isset($eformObj->inspection->resident_signature_date) && $eformObj->inspection->resident_signature_date !='0000-00-00')?$eformObj->inspection->resident_signature_date:'', ['id'=>'fromdate', 'class'=>'form-control','placeholder' => '']) }}
                                 
                                 </div>
                                <!-- {{ Form::text('resident_signature_date', isset($eformObj->inspection->resident_signature_date)?$eformObj->inspection->resident_signature_date:'', ['class'=>'form-control','required' => true,'placeholder' => 'Enter date of resident signature']) }}
                              -->
                           </div>
                           </div>
						   <div class="col-lg-4">
                           ...
                           <div class="form-group ">
                              ...
                              <div class="">
                                <img src="data:image/png;base64, {{$eformObj->inspection->manager_signature}}" class="viewsig"/>
                              </div>
                           </div>
                           </div>
                           @endif
                           ...
                           <div class="form-group ">
                              ...
                              <div id="sandbox2">
                                 {{ Form::text('date_of_signature', (isset($eformObj->inspection->date_of_signature) && $eformObj->inspection->date_of_signature !='0000-00-00')?$eformObj->inspection->date_of_signature:'', ['id'=>'todate', 'class'=>'form-control','placeholder' => '']) }}
                                 </div>
                              <!--   {{ Form::text('date_of_signature', isset($eformObj->inspection->date_of_signature)?$eformObj->inspection->date_of_signature:'', ['class'=>'form-control','required' => true,'placeholder' => 'Enter date of management signature']) }}
                              -->  
                           </div>
                           </div>
                        </div> 
                  ...
                  <h2>defects</h2>
                     ...
                     <div class="col-lg-6" id="add_field{{$i}}" style="{{$display_style}}">
							...
							<div class="clbord clfet">
                              ...
                              <div class="row" >
                           <div class=" col-lg-2 " id="buttonsection">   <a class="addrow "
                           id="addBtn" type="button" onclick="showmore()">
                      <img src="{{url('assets/img/plus.png')}}" class="upimg"/><br> Add File
                        </a></div>
						</div>
