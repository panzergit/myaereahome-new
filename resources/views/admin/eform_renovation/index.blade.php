...
@php 
   ...
   $permission = $permission->check_permission(41,$permission->role_id); 
@endphp

<div class="status">
  <h1>Renovation Applications</h1>
</div>
<div class="row">
               <div class="col-lg-12">
               <ul class="summarytab">
...
<form action="{{url('/opslogin/eform/renovation/search')}}" method="get" role="search" class="forunit">
                     ...
                     <div class="row asignbg">
                        ...
                        <div class="col-lg-4">
                           <div class="form-group mt0-3">
							     ...
							     <a href="{{ url('/opslogin/exportrenovation?option='.$option.'&ticket='.$ticket.'&unit='.$unit.'&name='.$name.'&status='.$status) }}" class="submit  float-right">print</a>
                          <a href="{{url("/opslogin/eform/renovation")}}"  class="submit ml-2 mr-2 float-right">clear</a>
          ...
          <div class="overflowscroll2">
                  ...
                  @endphp</td>
                           ...
                           <a class="dropdown-item" href="{{$visitor_app_url}}/renovation-pdf/{{$form->id}}" target="blank">List</a>
