...
<!-- Content Header (Page header) -->
  ...
  <div class="status">
    <h1>visitor management - add purpose </h1>
  </div>
<div class="row">
               <div class="col-lg-12">
               <ul class="summarytab">
      ...
      @endif
       ...
       <div class="">
                 {!! Form::open(['method' => 'POST','class'=>"forunit", 'url' => url('opslogin/configuration/purpose'), 'files' => false]) !!}
                     ...
                     <div class="row">
                        <div class="col-lg-8">
                           <div class="form-group row">
                              ...
                              <div class="col-sm-5">
                                 {{ Form::select('account_id', ['' => '--Select Property--'] + $properties, null, ['class'=>'form-control wauto','required' => true]) }}
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="row">
                           <div class="col-lg-12 tbodynew" id="tbody">
                              ...
                              <div class="clbord clfett row">
                                    <div class="col-lg-6">
                                       <div class="form-group row">
                                          ...
                                          <div class="col-sm-5 col-12 ">
                                             {{ Form::text('visiting_purpose', null, ['class'=>'form-control','required' => true,'placeholder' => 'Enter Visiting Purpose']) }}
                                    ...
                                    <div class="col-sm-5 col-12  ">
                                    {{ Form::number('qr_scan_limit', 1, ['class'=>'form-control','required' => true,'placeholder' => 'Enter QR Scan Limit','min'=>1]) }}
                                 ...
                                 @endfor
                                       <div class="col-lg-12 ml-1" id="buttonsection">
