...
<!-- Content Header (Page header) -->
  ...
  <div class="row">
      ...
      @endif
       ...
       <div class="">
            {!! Form::open(['method' => 'POST','class'=>"forunit", 'url' => url('opslogin/magazine'), 'files' => true]) !!}
...
-->
                  ...
                  @for($i=1;$i<=1;$i++)
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-8">
						               <input type="file" name="file_image_{{$i}}" id="file_image_{{$i}}" class="form-control" >
                              </div>
                           </div>
                        </div>
              ...
              @if(1==2)
               <div class="row" >
                  <div class="col-12 col-lg-6 paddres" id="buttonsection">   
                     <a class="addrow "
