...
<!-- Content Header (Page header) -->
  ...
  <div class="row">
      ...
      @endif
       ...
       <div class="">
       {!! Form::model($fileObj,['method' =>'PATCH','class'=>"forunit",'files' => true,'url' => url('opslogin/magazine/'.$fileObj->id)]) !!}
...
-->
                            ...
                            <a href="#" class="closopity"  onclick='deleteMagazineFile("{{$fileObj->id}}")'><img src="{{url('assets/admin/img/deleted.png')}}" class="viewimg phvert"></a>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                ...
                                @if(isset($fileObj->file_image) &&  $fileObj->file_image !='')
                                  <img src="{{$img_full_path}}/{{$fileObj->file_image}}" id="preview-file-input"  class="viewimgfile" >
                                @endif
                              </div>
                           </div>
                           </div>
