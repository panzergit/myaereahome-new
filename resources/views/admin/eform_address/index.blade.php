...
@php 
   ...
   $permission = $permission->check_permission(44,$permission->role_id); 
@endphp

<div class="status">
  <h1>Changing Mailing Address Applications</h1>
</div>
<div class="row">
               <div class="col-lg-12">
               <ul class="summarytab">
...
<form action="{{url('/opslogin/eform/changeaddress/search')}}" method="get" role="search" class="forunit">
                     ...
                     <div class="row asignbg">
                        ...
                        <div class="col-lg-4">
                           <div class="form-group mt0-2">
							    ...
							    <a href="{{ url('/opslogin/exportmailingaddress?option='.$option.'&ticket='.$ticket.'&unit='.$unit.'&name='.$name.'&status='.$status) }}" class="submit  float-right">print</a>
                         <a href="{{url("/opslogin/eform/changeaddress")}}"  class="submit mr-2 ml-2 float-right">clear</a>
...
<div class="overflowscroll2">
                  ...
                  @endphp</td>
                           ...
                           <a class="dropdown-item" href="{{$visitor_app_url}}/address-pdf/{{$form->id}}"  target="blank">List</a>
