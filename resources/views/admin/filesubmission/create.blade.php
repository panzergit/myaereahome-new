       ...
       <div class="containerwidth">
                 ...
                 <div class="pt-4">
					...
					<label> CATEGORY NAME:</label>
                              ...
                              <div class="col-sm-6">
                              {{ Form::text('docs_category', null, ['class'=>'form-control','required' => true,'placeholder' => 'Enter Category Name']) }}                              </div>
                           </div>
						    </div>
						    </div>
                           ...
                           <div class="form-group row ">
                              ...
                              <label>FILE UPLOAD: </label>
                                    ...
                                    <input type="hidden" name="original_file_name_{{$i}}" id="preview_input_{{$i}}" value="" class="form-control">
                                       <img src="{{url('assets/admin/img/Files.png')}}" id="#preview-file-input_1"  class="imgview">
                                    </div>              
