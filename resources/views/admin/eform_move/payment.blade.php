    ...
    <img src="">
       ...
       <div class="">
            <div class="  ">
                 ...
                 {!! Form::model($eformObj,['method' =>'PATCH','class'=>"forunit", 'autocomplete'=>"off", 'url' => url('opslogin/eform/moveinout/paymentsave/'.$eformObj->id)]) !!}
                        ...
                        <div class="col-lg-" id="lift_receipt" style='display:{{(isset($eformObj->payment->lift_payment_option) &&$eformObj->payment->receipt_no!="")?"block":"none"}}'>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-12 col-12 mt-2">
                                 ...
                                 <button type="submit" class="submit   ml-2 float-right">update</button>
                                 <a href="{{url("/opslogin/eform/moveinout")}}"  class="submit float-right">cancel</a>
                              </div>
                           </div>   
                        </div>
						    </div>
