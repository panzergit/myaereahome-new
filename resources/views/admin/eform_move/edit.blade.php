...
@section('content')
 ...
 <div class="status">
    <h1>moving in & out application - update </h1>
  </div>
<div class="row">
               <div class="col-lg-12">
                  <ul class="summarytab">
  ...
  <div class="img-show">
    ...
    <img src="">
       ...
       <div class="">
                 {!! Form::model($eformObj,['method' =>'PATCH','class'=>"forunit",'url' => url('opslogin/eform/moveinout/'.$eformObj->id)]) !!}
					   ...
					   <div class="row asignbg editbg">
					    <div class="col-lg-3 col-6">
                          ...
                          <div class="form-group ">
						   ...
						   <div class="col-lg-3 col-6">
                          <div class="form-group ">
                             <label>name of mover company : 
                             </label>
                            <h4>  {{$eformObj->mover_comp}}</h4>
                          </div>
                          </div>
						   <div class="col-lg-3 col-6">
                          <div class="form-group ">
                          ...
                          <div class="form-group ">    
                            ...
                            <h4>  {{date('d/m/y',strtotime($eformObj->moving_start))}}</h4>
                          </div>
                          </div>
						   <div class="col-lg-3 col-6">
                          <div class="form-group ">    
                             ...
                             <h4> {{date('d/m/y',strtotime($eformObj->moving_end))}} </h4> 
                          </div>
                          </div>
                          @if(isset($eformObj->owner_signature))
                             ...
                             <div class="form-group ">
                                 ...
                                 <div class="">
                                    <a href="#" target="_blank"><img src="data:image/png;base64, {{$eformObj->owner_signature}}" class="viewimg"/></a>
                                 </div>
                              </div>
                              </div>
                              @endif   
 ...
 <div class="col-lg-3 col-6">								  
                              <div class="form-group ">
                                 ...
                                 <div class="">
                                    <a href="#" target="_blank"><img src="data:image/png;base64, {{$eformObj->nominee_signature}}" class="viewimg"/></a>
                                 </div>
                              </div>
                              </div>
                           @endif
                  ...
                  <h2>management update </h2>
                     ...
                     <div class="form-group  ">
					  <button type="submit" class="submit mt-2 ml-2   float-left">update</button>
					   <a href="{{url("/opslogin/eform/moveinout")}}"  class="Delete mt-2 float-right">cancel</a>
