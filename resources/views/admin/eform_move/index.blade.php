...
@php 
   ...
   $permission = $permission->check_permission(40,$permission->role_id); 
@endphp

<div class="status">
  <h1>Moving In & Out Applications</h1>
</div>
<div class="row">
               <div class="col-lg-12">
                  <ul class="summarytab">
...
<form action="{{url('/opslogin/eform/moveinout/search')}}" method="get" role="search" class="forunit">
                     ...
                     <div class="row asignbg">
                        ...
                        <div class="form-group ">
                           ...
                           <div class="form-group ">
                              <label class="">status: 
                                  ...
                                  {{ Form::select('status', ['' => '--ALL--',0=>'NEW','3'=>'APPROVED',2=>'IN PROGRESS',1=>"CANCELLED","4"=>"REJECTED","5"=>"PAYMENT PENDING","6"=>"REFUNDED"], $status, ['class'=>'form-control','id'=>'role']) }}
                        ...
                        <div class="col-lg-5">
                           <div class="form-group mt0-2">
							   ...
							   <a href="{{ url('/opslogin/exportmoveinout?option='.$option.'&ticket='.$ticket.'&unit='.$unit.'&name='.$name.'&status='.$status) }}" class="submit  float-right">print</a>
                        <a href="{{url("/opslogin/eform/moveinout")}}"  class="submit  float-right ml-2 mr-2">clear</a>
...
<div class="overflowscroll2">
 <table class="gap">
                  ...
                  @endphp</td>
                           ...
                           <a class="dropdown-item" href="{{$visitor_app_url}}/moveinginout-pdf/{{$form->id}}"  data-toggle="tooltip" data-placement="top" title="List" target="_blank">List</a>
