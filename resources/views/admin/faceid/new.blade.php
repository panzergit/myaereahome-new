...
<div class="status">
  <h1>facial recognition new registration</h1>
</div>
  <div class="row">
               <div class="col-lg-12">
                  <ul class="summarytab">
                     <li><a href="{{url('/opslogin/faceid#fi')}}">Summary</a></li>
					   <li   class="activeul"><a href="{{url('/opslogin/faceid/new')}}">New Submission @if(isset($faceid_count) && $faceid_count >0 )
...
<form action="{{url('/opslogin/faceid/search')}}" method="get" role="search" class="forunit">
                     ...
                     <div class="row asignbg">
                        ...
                        <div class="col-lg-3">
                           <div class="form-group mt0-4  ">
							   ...
							   <a href="{{url("/opslogin/faceid/new")}}"  class="submit ml-2 float-right mtop4">clear</a>
...
<div class="overflowscroll2">
                        ...
                        <tr>
                          ...
                          <td class="spacer noimg">
                           ...
                           <td class="roundright">
                            ...
                            <a href="#" data-toggle="modal" data-target="#confirmModalCenter" data-id="{{$faceid->id}}" class="open-dialog-confirm"><img src="{{url('assets/admin/img/tick.png')}}" class="tickimg phvert"></a>
                            @endif
                           @if(isset($permission) && $permission->delete==1)
                            <a href="#"  data-toggle="modal" data-target="#exampleModalCenter" data-id="{{$faceid->id}}" class="open-dialog"><img src="{{url('assets/admin/img/cross.png')}}" class="tickimg phvert"></a>
                            @endif
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            {!! Form::open(['method' => 'POST', 'url' => url('opslogin/faceid/updatecancelstatus'), 'files' => false]) !!}
            {{ csrf_field() }}
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Facial Recognition - Cancel</h5>
