...
<div class="row">
      ...
      @endif
       ...
       <div class="">
                 {!! Form::open(['method' => 'POST','class'=>"forunit", 'url' => url('opslogin/configuration/defect'), 'files' => false]) !!}

              <div class="row asignbg">
                 <div class="col-lg-4">
                    <div class="form-group ">
                        <label>defect location :</label>
                              {{ Form::text('defect_location', null, ['class'=>'form-control','required' => true,'placeholder' => 'Enter defect location']) }}
                      </div>
                  </div>
                  </div>
  <div class="col-lg-12 asignFace">
                  ...
                  @for($i=1;$i<=10;$i++)
                              ...
                              <div class="col-lg-4 col-12" id="add_field{{$i}}" style="{{$display_style}}">
                                <div class="form-group ">
                                    <label>type {{$i}}:</label>
                                          {{ Form::text("defect_type_$i", null, ['class'=>'form-control','placeholder' => 'Enter defect type']) }}
                                  </div>
                              </div>
                              @endfor
							   </div>
                              <div class="row">
                              <div class="col-lg-12">
                              <a class="addrow   float-right mt-2 mb-4"
