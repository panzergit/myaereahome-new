...
@php 
   ...
   $property =  $permission->check_menu_permission(74,$permission->role_id,1);
                    ...
                    <div class="row">
                      <div class="col-lg-4">
                         <div class="form-group ">
                               <a href="{{url("/opslogin/configuration/defect/create#defectsettings")}}"  class="submit mt-4 ml-3 float-left" style="width:auto"> + Add New</a>
                           </div>
                       </div>
                    </div>
                    @endif
                      ...
                      @if($types)
                       ...
                       @foreach($types as $k => $type)
                        <tr>
                           ...
                           <td class="spacer">{{$type->defect_location}}</td>
                           ...
                           <a class="dropdown-item" href="{{url("opslogin/configuration/defect/$type->id/edit#defectsettings")}}">Edit</a>
                           @endif
                           @if(isset($permission) && $permission->delete==1)
                           <a class="dropdown-item" href="#" onclick="delete_record('{{url("opslogin/configuration/defect/delete/$type->id#defectsettings")}}');" >Delete</a>
                           @endif
                                    </div>
                                 </div>
