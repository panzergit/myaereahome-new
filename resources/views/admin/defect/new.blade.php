                     ...
                     <tbody>
                      @if($defects)
                       ...
                       @foreach($defects as $k => $defect)
                        ...
                        <tr>
                           <td>{{$defect->ticket}}</td>
                           <td>{{isset($defect->getunit->unit)?Crypt::decryptString($defect->getunit->unit):''}}</td>
                           ...
                           <td><a href="{{$visitor_app_url}}/generate-pdf/{{$defect->id}}"  title="List" target="_blank"><img src="{{url('assets/admin/img/Files.png')}}"></a></td>
                           <td>@php
