...
<!-- Content Header (Page header) -->
  ...
  <div class="status">
    <h1>condo document - new category </h1>
  </div>
  <div class="row">
               <div class="col-lg-12">
                  <ul class="summarytab">
                     <li><a href="{{url('/opslogin/docs-category#cd')}}">Summary</a></li>
                     <li  class="activeul"><a href="{{url('/opslogin/docs-category/create#cd')}}">Upload new document</a></li>
                  </ul>
               </div>
               </div>
      @if (session('status'))
      ...
      @endif
       ...
       <div class="">
                 {!! Form::open(['method' => 'POST','class'=>"forunit", 'url' => url('opslogin/docs-category'), 'files' => true]) !!}

                 <div class="">
					 <div class="row">
					 <div class="col-lg-4 mt-2 pl-4">
...
<div class="col-lg-8">
                  ...
                  @for($i=1;$i<=10;$i++)
							...
							<div class="clbord clfet" id="tbody">
					...
					<label>file name:</label>
						...
						<input type="text" name="file_name_{{$i}}" id="file_name_{{$i}}" class="form-control" placeholder="Define File Name">
                              ...
                              @endfor
                               ...
                               <div class="row" >
                           <div class="col-12 col-lg-6 paddres" id="buttonsection">   <a class="addrow "
