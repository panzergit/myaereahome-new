...
.btn-light:not(:disabled):not(.disabled).active, .btn-light:not(:disabled):not(.disabled):active, .show>.btn-light.dropdown-toggle{padding: 0px 10px !important; background: transparent; border: transparent;}
  ...
  <div class="p-2 saf100">  <img id="preview-file-input_2"  width="100px"></div>
  <div class="p-2 saf50"><img id="delete2" class="announcementdel"></div>
</div>
					 ...
					 <div class="form-group col-lg-6">
					 		   <div class="d-flex flex-sm-row flex-column">
  <div class="mr-auto p-2 saf100">   <div class="image-upload uplodinline">
                              <label for="file-input_3" class="file-55 file100" >
                                 <img src="{{url('assets/img/fileupload.png')}}" class="announcementimg" >
                              </label>
                              <input id="file-input_3" type="file" name="upload_3">
                        </div></div>
  <div class="p-2 saf100">  <img id="preview-file-input_3"  width="100px"></div>
   <div class="p-2 saf50"><img id="delete3" class="announcementdel"></div>
</div>
  ...
  <div class="p-2 saf100">  <img id="preview-file-input_4"  width="100px"></div>
    <div class="p-2 saf50"><img id="delete4" class="announcementdel"></a></div>
</div>
  ...
  <div class="p-2 saf100">  <img id="preview-file-input_5"  width="100px"></div>
   <div class="p-2 saf50"><img id="delete5" class="announcementdel"></div>
</div>
...
-->
                        ...
                        <div class="col-lg-12 ">
                        <input type="hidden" name="pdf_icon_path" id="pdf_icon_path" value="{{ url('assets/admin/img/fileshw.png') }}" />
                        <input type="hidden" name="delete_icon_path" id="delete_icon_path" value="{{ url('assets/admin/img/deleted.png') }}" />
