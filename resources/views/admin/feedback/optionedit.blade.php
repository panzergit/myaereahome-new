...
<div class="row">
      ...
      @endif
       ...
       <div class="">
                 {!! Form::model($feedbackObj,['method' =>'PATCH','class'=>"forunit",'url' => url('opslogin/configuration/feedback/'.$feedbackObj->id)]) !!}

                  <div class="row asignbg editbg">
                 <div class="col-lg-4">
                           <div class="form-group ">
                              <label>Feedback Option :</label>
                                {{ Form::text('feedback_option', null, ['class'=>'form-control','required' => true,'placeholder' => 'Enter Feedback Option']) }}
                           </div>
                </div>
               <div class="col-lg-4"></div>
               <div class="col-lg-4">
                           <button type="submit" class="submit mt-4 float-right">submit</button>
                        </div>
                     </div>
