               ...
               <div class="col-lg-12">
                  <ul class="summarytab">
                     ...
                     @if(isset($bluetooth->view) && $bluetooth->view==1 )
                        <li  class="activeul" ><a href="{{url('/opslogin/digitalaccess/remotedooropen')}}">Remote Records</a></li>
                     @endif
                     @if(isset($bluetooth->view) && $bluetooth->view==1 )
                        <li ><a href="{{url('/opslogin/digitalaccess/bluetoothdooropen')}}">Bluetooth Records</a></li>
                     @endif
                    ...
                    <!--<div class="row">
                     ...
                     <tbody>
                      @if($records)
                       ...
                       @php
                       $bt = new \App\Models\v7\RemoteDoorOpen();
                       $rec = $bt->deviceDetail($list->devSn);  
                      
                       @endphp
                        <tr>
                           <td class="roundleft">{{date('d/m/y',strtotime($list->created_at))}}</td>
                           <td class="spacer">{{date('G:i A',strtotime($list->created_at))}}</td>
