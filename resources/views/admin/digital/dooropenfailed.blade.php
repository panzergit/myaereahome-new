...
<div class="status">
   <h1>Digital Access - Failed Open Door Record</h1>
</div>
<div class="row">
               <div class="col-lg-12">
                  <ul class="summarytab">
                     ...
                     @if(isset($doorfailed->view) && $doorfailed->view==1 )
                        <li class="activeul"><a href="{{url('/opslogin/digitalaccess/dooropenfailed#odr')}}">Failed Records</a></li>
                     @endif
...
<div class="">
<form action="{{url('/opslogin/digitalaccess/searchdooropenfailed')}}" method="get" role="search" class="forunit">
                     <div class="">
						...
						<input id="datetime" type="time" class="form-control" name="endTime" value="{{ request()->has('endTime') ? request()->endTime : '' }}">
                              ...
                              <div class="col-lg-4">
                              <a href="{{url("/opslogin/digitalaccess/dooropenfailed")}}"  class="submit  ml-2 float-right">clear</a>
                      ...
                      @if($records)
                       ...
                       @foreach($records as $k => $record)
                        <tr>
                           ...
                           <td class="spacer">{{isset($record->user->getunit->unit)?Crypt::decryptString($record->user->getunit->unit):''}}</td>
                           ...
                           <td class="roundright">
                           @php
                           if($record->eventType ==74)
                              echo "QR code failed to open the door";
                           else
                              echo "Failled";
                           @endphp</td>
                           <!--<td>
