               ...
               <div class="col-lg-12">
                  <ul class="summarytab">
                     @if(isset($dooropen->view) && $dooropen->view==1 )
                        <li><a href="{{url('/opslogin/digitalaccess/dooropen#odr')}}">Normal / Remote / Face ID</a></li>
                     @endif
                     @if(isset($bluetooth->view) && $bluetooth->view==1 )
                        <li  class="activeul" ><a href="{{url('/opslogin/digitalaccess/bluetoothdooropen#odr')}}">Bluetooth Door Open Records</a></li>
                     @endif
                     @if(isset($doorfailed->view) && $doorfailed->view==1 )
                        <li ><a href="{{url('/opslogin/digitalaccess/dooropenfailed#odr')}}">Failed Open Door</a></li>
                     @endif
                     ...
                     @if(isset($qrcode->view) && $qrcode->view==1 )
                        <li ><a href="{{url('/opslogin/digitalaccess/qropenrecords#odr')}}">QR Code Open Records</a></li>
                     @endif
                  </ul>
               </div>
               </div>
