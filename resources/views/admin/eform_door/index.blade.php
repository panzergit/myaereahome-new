...
@php 
   ...
   $permission = $permission->check_permission(42,$permission->role_id); 
@endphp

<div class="status">
  <h1>Door Access Card Applications</h1>
</div>
<div class="row">
               <div class="col-lg-12">
               <ul class="summarytab">
...
<form action="{{url('/opslogin/eform/dooraccess/search')}}" method="get" role="search" class="forunit">
                     ...
                     <div class="row asignbg">
                        ...
                        <div class="col-lg-4">
                           <div class="form-group mt0-2">
							     ...
							     <a href="{{ url('/opslogin/exportdooraccess?option='.$option.'&ticket='.$ticket.'&unit='.$unit.'&name='.$name.'&status='.$status) }}" class="submit  float-right">print</a>
                          <a href="{{url("/opslogin/eform/dooraccess")}}"  class="submit  ml-2 mr-2 float-right">clear</a>
...
<div class="overflowscroll2">
                 <table class="gap">
                  ...
                  @endphp</td>
                           ...
                           <a class="dropdown-item" href="{{$visitor_app_url}}/dooraccess-pdf/{{$form->id}}"   target="_blank" >List</a>
