                      ...
                      @if($devices)
                       ...
                       ?>
                        ...
                        @endif
                           ...
                           <td class="spacer"><a href="#" onclick="device_status({{$account_id}},{{$dept->device_serial_no}},'dev_status_{{$dept->id}}')"><div id='dev_status_{{$dept->id}}'><span class="chkstatus">Check Status</span></div></a></td>
