...
$BlkUserObj = new \App\Models\v7\ChatBoxBlockUserByAdmin();
  ...
  <div class="row">
               <div class="col-lg-12">
                  <ul class="summarytab">
                     ...
                     <li  class=" allnotif"><a href="{{url('/opslogin/resichat/allreports')}}">All Reports <span class="notification">{{$newreport_count}}</span></a></li>
                     <li class="activeul pl30"><a href="{{url('/opslogin/resichat/blockedusers')}}">Blocked Users</a></li>
                           ...
                           <td class="roundright">
							   ...
							   <div class="dropdown">
                                       ...
                                       <div class="dropdown-menu">
                                          @if($user->status ==1)
                                             <a class="dropdown-item" href="{{url("opslogin/resichat/unblockuser/$user->id")}}">Unblock</a>
                                          @else
                                             <a class="dropdown-item" href="{{url("opslogin/resichat/blockagainuser/$user->id")}}">Block</a>
                                          @endif
