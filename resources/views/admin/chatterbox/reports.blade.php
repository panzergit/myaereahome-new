...
<div class="status mtsuperadmin topich row">
 <div class="col-lg-6">
  ...
  <h3>Topic : {{$ChatObj->subject}}</h3>
     ...
     <div class="col-lg-6">
  <a href="{{url("opslogin/resichat/allreports")}}" class='submitchat  float-right'>Back to report</a>
  </div>
</div>
                        ...
                        <tr>
                           ...
                           <td class="roundright">
							   ...
							   <div class="dropdown">
                                       ...
                                       @if($user->status ==1)
                                             <a class="dropdown-item" href="{{url("opslogin/resichat/hidereport/$user->id")}}">Hide</a>
                                          @else
                                             <a class="dropdown-item" href="{{url("opslogin/resichat/showreport/$user->id")}}">Show</a>
                                          @endif
                                          <a class="dropdown-item" href="{{url("opslogin/resichat/warninguser/$user->id")}}">Warning User</a>
                                          <a class="dropdown-item" href="{{url("opslogin/resichat/blockuser/$user->id")}}">Block User</a>
