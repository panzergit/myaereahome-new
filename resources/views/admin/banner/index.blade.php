                    ...
                    <div class="row">
                      <div class="col-lg-4">
                         <div class="form-group row">
                               <a href="{{url("/opslogin/configuration/banner/create")}}"  class="submit ml-3 mt-2 float-left" style="width:auto"> + Add New</a>
                           </div>
                       </div>
                    </div>
                     @endif
                     ...
                     <tbody>
                      @if($banners)
                        ...
                        <tr>
                           ...
                           <td  class="spacer">@if(!empty($banner->banner_image))
                                       <div class="image-upload">
                                          <label for="file-input">
                                          <img src="{{$file_path}}/{{$banner->banner_image}}" class="viewimg"/>
                                          </label>
                                       </div>
                                    @endif</td>
                           <td  class="spacer">{{$banner->banner_title}}</td>
                           <td  class="roundright">
                              <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                          <a class="dropdown-item"  href='{{url("opslogin/configuration/banner/$banner->id/edit")}}'>Edit</a>
                           
                              @if($banner->status ==0)
                                 <a class="dropdown-item"  href="#" alt="Activate"  onclick="activate_record('{{url("opslogin/configuration/banner/activate/$banner->id")}}');">Deactive</a>
                              @else
                                 <a class="dropdown-item"  href="#"  onclick="deactivate_record('{{url("opslogin/configuration/banner/deactivate/$banner->id")}}');" >Active</a>
                              @endif
                              
                              <a class="dropdown-item"  href="#" onclick="delete_record('{{url("opslogin/configuration/banner/delete/$banner->id")}}');" >Delete</a>
