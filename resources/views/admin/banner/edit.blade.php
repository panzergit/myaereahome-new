...
<div class="row">
      ...
      @endif
       ...
       <div class="">
                {!! Form::model($bannerObj,['method' =>'PATCH','class'=>'forunit','files' => true,'url' => url('opslogin/configuration/banner/'.$bannerObj->id)]) !!}
                ...
                <div class="row asignbg editbg">
                    ...
                    <div class="col-lg-9">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                           <div class="form-group row">
                           @if(!empty($bannerObj->banner_image))
                             <div class="col-sm-4">
                                 <label for="file-input">
                                    <img src="{{$file_path}}/{{$bannerObj->banner_image}}" class="viewimg"/>
                                 </label>
                              </div>
                           @endif
                              <div class="col-sm-6">
                    ...
                    <div class="col-lg-9">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                           <div class="form-group row">
                             <div class="col-sm-4">
                             {{ Form::select('banner_url_type', ['0' => 'No Link','1'=>'External Link','2'=>'Internal Link'] ,$bannerObj->banner_url_type, ['class'=>'form-control selectlink']) }}
                              </div>
                              <div class="col-sm-6  box 1">
                              {{ Form::text('banner_url', null, ['class'=>'form-control']) }}
                              </div>
                              <div class="col-sm-3 box 2 pr-0"> 
                                 {{ Form::select('module', ['announcement'=>'Announcement','chat'=>'Chat','defects'=>'Defects','facility'=>'Facility Booking','feedback'=>'Feedback','magazine' => 'Magazine','marketplace'=>'Marketplace','resident management'=>'Resident Management','vistor management'=>'Vistor Management'] ,$bannerObj->module, ['class'=>'form-control']) }}  
                              </div>
							  <label  class="col-sm-2 col-form-label  box 2">
                              <label>Ref. Id: </label>
                           </label>
                               <div class="col-sm-3 box 2 pl-0">
                  ...
                  <div class="overflowscroll">
                     ...
                     <thead>
                        <tr>
						   ...
						   <!--input type="checkbox" class="id1" name="property_13" value="1" style="margin-bottom: 0px; height: auto;"-->  </th>
                        </tr>
                     </thead>
                     <tbody>
