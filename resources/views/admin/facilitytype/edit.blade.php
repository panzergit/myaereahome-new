...
<div class="row">
      ...
      @endif
       ...
       <div class="">
       {!! Form::model($facilityObj,['method' =>'PATCH','class'=>"forunit", 'files' => true,'url' => url('opslogin/configuration/facility/'.$facilityObj->id)]) !!}
...
<div class="row asignbg editbg">
  ...
  <div class="col-lg-6">
      <div class="form-group ">
          <label>facility image <span>*</span>: </label>
              @if(!empty($facilityObj->facility_image))
                    <span for="file-input">
                       <a href="{{$file_path}}/{{$facilityObj->facility_image}}" target="_blank"><img src="{{$file_path}}/{{$facilityObj->facility_image}}" class="viewimg"/></a>
                    </span>
              @endif
  ...
  <div class="col-lg-6">
      <div class="form-group row">
        <label class="col-lg-12">next booking allowed :</label>
  <div class="col-lg-6">
      ...
      @if($propertyObj->opn_secret_key !='')
	      <div class="row">
	         <div class="col-sm-12">
               ...
               <input type="checkbox" name="payment_required" value="1" class="viewCheckBox requestshow" {{($facilityObj->payment_required ==1)?'checked="checked"':''}}>
      ...
      <br>
      <div class="form-group row">
         <div class="col-sm-6 {{($facilityObj->payment_required ==1)?'perquessthide':''}}">
            <label>fee  :</label>
...
@endif
 <div class="col-lg-6">
      <div class="form-group ">
        <label>booking timing slot:<p class="pcp">(Separate time slot by comma,<br>example:10:00AM,11:00AM,<br> or 10:00AM-12:00PM.)</p></label>
...
example 2021-10-01,2021-10-31</p></label>
   ...
   <div class="col-lg-6">
      <div class="form-group ">
        <label>notes:</label>
        {{ Form::textarea('notes', null, ['class'=>'form-control','rows'=>10,'required' => false,'placeholder' => 'Enter notes']) }}
