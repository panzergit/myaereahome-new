						...
						<td>
							...
							<tr>
								...
								<tr>
									...
									<p style="text-align:left">{{$name}} has sent you an invitation to visit on {{$date}}.<br> For a seamless entry experience, kindly <a href="{{$url}}" target="_blank">Click Here</a> to pre-register your details prior to your arrival. 
									</p>
									</td>
								</tr>
								<tr>
