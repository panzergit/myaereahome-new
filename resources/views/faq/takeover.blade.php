                     ...
                     <div class="accordion" id="faq">
                        ...
                        <div class="card">
                           ...
                           <div id="faq2" class="collapse" aria-labelledby="faqhead2" data-parent="#faq">
                              <div class="card-body">
                                 Kindly contact the managing agent via the contact provided with the invitation letter to download and install Aerea Home Mobile App. You can book a new appointment only after the managing agent has cancelled your appointment from their system
                              </div>
                           </div>
                        </div>
                     </div>
