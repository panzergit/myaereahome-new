                    ...
                    <table style="width:100%; border-collapse: collapse;">
                        <tr>
                            <td>
								...
								<div id="notesid" class="line" style="  font-family: 'Lato', sans-serif; font-size:10px; border: 1px solid #c0c0c0 ;  text-align:justify; line-height:11px;  background: #dee2e6; padding:6px; margin-left:22px; height:auto; padding-top:20px; margin-top:20px; padding-bottom:20px; margin-bottom:20px;">@php echo nl2br($invoice->notes) @endphp 
								</div>
