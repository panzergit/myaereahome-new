...
<div class="footer" style=" height:100vh; vertical-align:bottom; position:relative;
    page-break-inside: avoid;
                page-break-after: avoid;   min-height: 100vh;  bottom:-370;
                        ...
                        <td style="background:#ffffff; text-align:left;  width:50%; vertical-align: top; margin-top: 15px;">
                            <table style="width:100%;  border-collapse: collapse; margin-top: 7px;">
                                ...
                                <tr style="border:1px solid black;">
                                    <td style="padding-left:2px; border: 1px solid #d9d9d9;font-size:10px; line-height: 1.6;"> @if(isset($purchasers)) @foreach($purchasers as $k => $purchaser) @php if($k >0) echo ", "; @endphp <b>{{isset($purchaser->first_name)?Crypt::decryptString($purchaser->first_name):''}} {{isset($purchaser->last_name)?Crypt::decryptString($purchaser->last_name):''}}</b> @endforeach @endif
                            ...
                            <table style="width:100%; margin-bottom: 40px;">
                                <tr>
								 ...
								 <tr>
                                    ...
                                    <td style="font-size:10px; padding-top: 8px; text-align:right;"></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
