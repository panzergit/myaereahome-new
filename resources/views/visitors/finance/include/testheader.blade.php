        ...
        <table border="0" align="center" style="margin:0 auto; ma-width:400px; width:100%; background:#ffffff;  border-collapse: collapse;">
            <tr>
                ...
                <td style="background:#ffffff;color:#454545;text-align:left;  width:50%;     vertical-align: top;     ">
                    ...
                    <br >Unit No: -#{{isset($Unitinvoice->getunit->unit)?Crypt::decryptString($Unitinvoice->getunit->unit):''}}</p>
                </td>
                ...
                <td style="background:#ffffff;color:#454545;text-align:left;  width:33%; vertical-align: top;">
                    ...
                    <table style="width:100%; margin-top: -10px;  border-collapse: collapse;">
                        ...
                        <tr>
                            ...
                            <td style="font-family: 'Lato', sans-serif;font-size:10px;">{{isset($Unitinvoice->getunit->buildinginfo->id)?str_pad($Unitinvoice->getunit->buildinginfo->id, 4, '0', STR_PAD_LEFT):''}}-#{{isset($Unitinvoice->getunit->unit)?Crypt::decryptString($Unitinvoice->getunit->unit):''}}</td>
                        </tr>
                        <tr>
            ...
            <tr>
                ...
                <td style="background:#ffffff;color:#454545;text-align:left;  width:50%;     vertical-align: top;     ">
                    <p style="padding-left:2px; border: 1px solid #9e9e9e; font-family: 'Lato', sans-serif;font-size:10px; text-align:left; padding:4px 6px; line-height: 1.6;"><b>Mailing Address</b>
                        <br/> @if(isset($primary_contact)) {{Crypt::decryptString($primary_contact->first_name)}} {{isset($primary_contact->last_name)?Crypt::decryptString($primary_contact->last_name):''}}
                        <br /> @php echo isset($primary_contact->mailing_address)?nl2br($primary_contact->mailing_address):'' @endphp
                        <br/> @php echo isset($primary_contact->country)?strtoupper($primary_contact->usercountry->country_name):'' @endphp @php echo isset($primary_contact->postal_code)?" ".nl2br($primary_contact->postal_code):'' @endphp @endif
                    </p>
                </td>
                <td style="background:#ffffff;color:#454545;text-align:left;  width:16%; vertical-align: top;"></td>
                <td style="background:#ffffff;color:#454545;text-align:left;  width:33%; vertical-align: top;">
                    <p style="padding-left:2px; border: 1px solid #9e9e9e; font-family: 'Lato', sans-serif;font-size:10px; text-align:left; padding:4px 6px; line-height: 1.6;"> <b>Billing Address</b>
                        <br/>@if(isset($purchasers)) @php $counts =0; @endphp @foreach($purchasers as $k => $purchaser) @if($purchaser->status ==1) @php if($counts >0) echo ", "; @endphp {{Crypt::decryptString($purchaser->first_name)}} {{isset($purchaser->last_name)?Crypt::decryptString($purchaser->last_name):''}}
