...
<html>
<head>
<title>Batch - {{$invoice->batch_no}}</title>
...
@if(isset($invoicesLists) && !empty($invoicesLists))
   @foreach($invoicesLists as $invoicesList)
      ...
      $Unitinvoice = $invoicesList['Unitinvoice'];
      $invoice = $invoicesList['invoice'];
      $buildings = $invoicesList['buildings'];
      $purchasers = $invoicesList['purchasers'];
      $primary_contact = $invoicesList['primary_contact'];
      ...
      <table border="0" align="center" style="margin:0 auto; ma-width:400px; width:100%; background:#ffffff;  border-collapse: collapse;">
                           ...
                           <tr>
                              <td style="background:#ffffff;color:#000;text-align:left;  width:100%">
                                 <table style="width:100%; border-collapse: collapse;">
                                    ...
                                    @if(isset($previousDetails)) @foreach($previousDetails as $detail) @if($detail->total_amount >0 && $detail->status==0)
                                          <tr>
                                             ...
                                             <td style="vertical-align: text-top; border-bottom: 0px solid #fff!important; border-top: 0px solid #fff!important;  padding-left:8px; border-right: 1px solid #d9d9d9; border-left: 1px solid #d9d9d9; font-family: 'Lato', sans-serif;font-size:9px;     text-align: right; padding-right:8px; line-height: 1.6;">0.00
                                             </td>
                                             <td style=" vertical-align: text-top; border-bottom: 0px solid #fff!important; border-top: 0px solid #fff!important;  padding-left:8px; border-right: 1px solid #d9d9d9; border-left: 1px solid #d9d9d9; font-family: 'Lato', sans-serif;font-size:9px;     text-align: right; padding-right:8px; line-height: 1.6;">{{number_format($detail->amount,2)}}</td>
                                          </tr>
                                    ...
                                    @if(isset($currentDetails)) @foreach($currentDetails as $detail) @if($detail->total_amount >0)
                                          <tr>
        ...
        @endif
                        ...
                        <textarea style="font-family: 'Lato', sans-serif; font-size:10px; border: 1px solid #c0c0c0 ; height: auto; text-align:justify; line-height:16px; white-space: pre-line; background: #dee2e6; padding:6px; margin-left:22px; line-height:11px;">@php echo nl2br($invoice->notes) @endphp</textarea>		
