...
<html>
   <body >
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
         <tr>
            <td style="background:#ffffff; color:#454545;text-align:center;padding:10px 15px; width:100%;">
               <b style="text-align:center">MOVING IN & OUT APPLICATION - PDF
               </b>
            </td>
         </tr>
		   <!-- toptext -->
                     ...
                     <td style="color:#454545; vertical-align: top;" >
                        <table border="0"  cellpadding="3" cellspacing="0" width='100%' style='width:100%'>
						   ...
						   <tr>
						    ...
						    <tr>
                              <td style="color:#454545;" width="55%">
                                 <b >Name of mover company :</b>
                              </td>
                              <td style="color:#454545; text-align:left;" width="45%">
                                 <i>{{$eformObj->mover_comp}}</i>
                              </td>
                           </tr>
						   <tr>
                              <td style="color:#454545;" width="55%">
						   ...
						   <tr>
                              ...
                              <td style="color:#454545; text-align:left;" width="45%">
                                 <i>{{date('d/m/y',strtotime($eformObj->moving_start))}}</i>
                              </td>
                           </tr>
			      </table>
            </td>
                        ...
                        <table border="0"  cellpadding="3" cellspacing="0" width='100%' style='width:100%'>
						   ...
						   <tr>
						    ...
						    <tr>
                              ...
                              <td style="color:#454545;" width="45%">
                                <i> {{date('d/m/y',strtotime($eformObj->moving_end))}}</i>
                              </td>
                           </tr>
			      </table>
            </td>
