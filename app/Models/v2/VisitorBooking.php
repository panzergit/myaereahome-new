...
class VisitorBooking extends Model
{
    ...
    public function visitpurpose(){
        return $this->belongsTo('App\Models\v2\VisitorType','visiting_purpose');
    }
    ...
    public function visitors(){
        return $this->hasMany('App\Models\v2\VisitorList','book_id');
    }

    public function invitedemails(){
        return $this->hasMany('App\Models\v2\VisitorInviteEmailList','book_id');
    }
