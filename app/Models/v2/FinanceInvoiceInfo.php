...
class FinanceInvoiceInfo extends Model
{
    ...
    public function details(){
        return $this->hasMany('App\Models\v2\FinanceInvoiceDetail','info_id')->orderBy('id','asc');;
    }

    public function admininfo(){
        return $this->belongsTo('App\Models\v2\User','created_by');
    }

    public function invoices(){
        return $this->hasMany('App\Models\v2\FinanceInvoice','info_id');
    }
