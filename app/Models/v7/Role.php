...
class Role extends Model
{
   ...
   // protected $table = 'unites';
    ...
    public function Permissions(){
        return $this->hasMany('App\Models\v7\ModuleSetting','role_id');
    }
    ...
    public function roledevices(){
        return $this->hasMany('App\Models\v7\RoleDevice','role_id');
    }

    public function roleremotedevices(){
        return $this->hasMany('App\Models\v7\RoleRemoteDevice','role_id');
    }
...
public function role_access_api($token,$role,$account_id,$devices) {
