...
class MpAdsReport extends Model
{
     protected $fillable = [
        'account_id','user_id','unit_no','ref_id','spam','remark','status','view_status'
    ];
    ...
    public function gettitle(){
        return $this->belongsTo('App\Models\v7\MpAdsSubmission','ref_id');
    }
