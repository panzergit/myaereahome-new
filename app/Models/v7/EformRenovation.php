...
{   	
    ...
    protected $fillable = [
        ...
        public function sub_con(){
            return $this->hasMany('App\Models\v7\EformRenovationSubCon','reno_id');
        }

        public function details(){
            return $this->hasMany('App\Models\v7\EformRenovationDetail','reno_id');
        }

        public function payment(){
            return $this->hasOne('App\Models\v7\EformRenovationPayment','reno_id');
        }

        public function inspection(){
            return $this->hasOne('App\Models\v7\EformRenovationInspection','reno_id');
        }

        public function defects(){
            return $this->hasMany('App\Models\v7\EformRenovationDefect','reno_id');
        }
