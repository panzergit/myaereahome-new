...
class FinanceInvoice extends Model
{
    ...
    public function invoice_info(){
        return $this->belongsTo('App\Models\v7\FinanceInvoiceInfo','info_id');
    }

    public function paymentdetails(){
        return $this->hasMany('App\Models\v7\FinanceInvoicePaymentDetail','invoice_id')->orderBy('display_order')->orderBy('order');
    }

    public function payments(){
        return $this->hasMany('App\Models\v7\FinanceInvoicePayment','invoice_id')->orderBy('id','desc');
    }

    public function AdvancePayment(){
        return $this->hasOne('App\Models\v7\FinanceAdvancePayment','invoice_id')->orderBy('id','desc');
    }

    public function CreditPayments(){
        return $this->hasMany('App\Models\v7\FinanceCreditPayment','invoice_id')->orderBy('id','desc');
    }

    public function PaymentLog(){
        return $this->hasOne('App\Models\v7\FinancePaymentLog','invoice_id')->orderBy('id','desc');
    }
    ...
    public function invoicecounts($info_id){
        ...
        $count=count($records);
        return $count;
        //return $this->belongsTo('App\Models\v7\FinanceInvoice','info_id');
    }
    ...
    public function previousinvoice_new($unit,$interest_percentage,$invoice_date) {
        ...
        $result = array();
        //$thisclass = new \App\Models\v7\FinanceInvoice();
