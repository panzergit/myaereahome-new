...
class FinanceInvoicePayment extends Model
{
    ...
    public function paymentdetails(){
        return $this->hasMany('App\Models\v7\FinanceInvoicePaymentPaidDetail','payment_id')->orderBy('id','asc');;
    }
    

    public function invoicerecord(){
        return $this->belongsTo('App\Models\v7\FinanceInvoice','invoice_id')->orderBy('id','asc');;
    }
