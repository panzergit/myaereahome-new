...
class FrontController extends Controller
{
    ...
    public function saveSignature(Request $request)
    {
        if($request->action=='draw_signature'){
            ...
            $filePath = remove_upload_path($request->file('file')->store(upload_path('user_signatures')));
        }
    ...
    public function settingpassword(Request $request) {
	 ...
	 public function settingprofilepic(Request $request) {
        ...
        if ($request->file('profile_picture') != null) {
            $UserMoreObj->profile_picture = remove_upload_path($request->file('profile_picture')->store(upload_path('profile')));
        }
