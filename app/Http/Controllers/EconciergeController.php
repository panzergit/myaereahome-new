...
class EconciergeController extends Controller
{
    ...
    {      
       $input = $request->all();
        ...
        if ($request->file('banner_image') != null) {
            $input['banner_image'] = remove_upload_path($request->file('banner_image')->store(upload_path('econcierge')));
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->file('banner_image') != null) {
            $BannerObj->banner_image = remove_upload_path($request->file('banner_image')->store(upload_path('econcierge')));
        }
